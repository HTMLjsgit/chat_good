...
ActiveRecord::Schema.define(version: 2020_12_31_230603) do
  ...
  create_table "message_replies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "content"
  ...
  create_table "rooms", id: :string, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "password"
    t.boolean "bot", default: false
    t.boolean "message_notification", default: false
  end
  ...
  create_table "usermanagers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "ip_id"
    t.boolean "login", default: false
    t.boolean "message_limit", default: false
    t.boolean "url_limit", default: false
    t.boolean "ng_word", default: false
    t.boolean "message_notification", default: false
  end
